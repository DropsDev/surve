...
<button type="button" class="btn btn-xs sidebar-slide-toggle text-white btn-link m-l-20 hidden-md-down" data-pages-toggle="#appMenu"><i class="fa fa-angle-down fs-16"></i>
</button>
<button type="button" class="btn btn-link hidden-md-down text-white" data-toggle-pin="sidebar"><i class="fa fs-12"></i>
</button>
</div>
</div>
